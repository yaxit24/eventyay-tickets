...
var editor = {
    ...
    _load_pdf: function (dump) {
        ...
        loadingTask.promise.then(function (pdf) {
            ...
            pdf.getPage(pageNumber).then(function (page) {
                ...
                let scaleX = editor.$cva.width() / page.getViewport(1.0).width;
                let scaleY = (window.innerHeight - 200) / page.getViewport(1.0).height;
                let scale = Math.min(scaleX, scaleY) * 1.0; // Responsive scaling
                
                let viewport = page.getViewport(scale);

                // Prepare canvas using PDF page dimensions
                let context = canvas.getContext('2ctx');
    ...
    // Removed _preview function as per UI simplification requirements
